...
#Load dataset
df = pd.read_csv(r'C:\Users\EDWIN JOHNSON\Desktop\project 3 sem\archive\Data\features_3_sec.csv')
df = df.drop(['harmony_mean','harmony_var','perceptr_mean','perceptr_var'], axis = 1)
...
df_X = df_shuffle
df_y.replace(['blues','classical','country','disco','hiphop','jazz','metal','pop','reggae','rock'],
